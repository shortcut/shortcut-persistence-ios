...
final class ShortcutPersistenceTests: XCTestCase {
    ...
    func test_get_single_object() {
        ...
        XCTAssertNotNil(persistance.get(object: TestObject.self), "Object are not saved correctly")
    }
    ...
    func test_get_single_object_by_index() {
        ...
        let retrievedFirstObject = persistance.get(object: TestObject.self)
    ...
    func test_remove_single_object() {
        ...
        XCTAssertNil(persistance.get(object: TestObject.self))
    }
    ...
    func test_remove_single_object_when_exist_more() {
        ...
        XCTAssertNotNil(persistance.get(object: TestObject.self))
    }
    ...
    func test_update_data() {
        ...
        let returnObject = persistance.get(object: TestObject.self)
